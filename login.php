                    ...
                    <div class="login_centro">
                        ...
                        <form name="formulario1" action="centroRecursosController.php" method="POST" onsubmit="return validar()" class="clase1" >
                            <div class="input-group margin-bottom-sm">
                                <span class="input-group-addon-pers"><i class="fa fa-user-circle fa-fw"></i></span>
                                <input class="form-control-pers" name="usuario" type="text" placeholder="Usuario">
                            </div>
                            <div class="input-group" style="padding-top: 1%; padding-bottom: 2%;">
                                <span class="input-group-addon-pers"><i class="fa fa-key fa-fw"></i></span>
                                <input class="form-control-pers" name="password" type="password" placeholder="Password">
                            </div>
