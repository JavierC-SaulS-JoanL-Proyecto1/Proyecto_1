...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2018 at 07:10 PM
...
--
CREATE DATABASE IF NOT EXISTS `proyecto1bd` DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci;
USE `proyecto1bd`;
...
('toniAdmin', 'sudo', 'Toni', 'DungeonMaster'),
