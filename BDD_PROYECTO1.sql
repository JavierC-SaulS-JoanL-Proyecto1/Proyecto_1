...
/*-------------------------------------------Tabla recursos---------------------------------------------------------*/
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('1','portatil-1','2',true,'Portátil HP Pavilion 14-ce0004ns 14" Intel Core i5: 
...
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('2','portatil-2','2',true,'Portátil ASUS VivoBook 15,6", AMD Quad-Core E2-6110 APU:
...
1 VGA D-Sub
1 Salida de audio
1 Lector de tarjetas SD multiformato TOSHIBA');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('4','movil-1','2',true,'Smartphone libre Huawei P20 Lite 64 GB + 4 GB Rosa:
...
NFC
Wi-Fi');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('5','movil-2','2',true,'El Xiaomi Mi A2 Lite ya ha llegado. Después del éxito conseguido por Xiaomi con el Mi A1, el fabricante chino acaba de presentar a uno de sus sucesores: el Xiaomi Mi A2 Lite.
Especificaciones técnicas:
...
Bluetooth');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('6','proyector-1','2',true,'Proyector EPSON ya instalado preparado para la proyección por varios métodos de conexión. Métodos:
  VGA X1
  HDMI X2
  MICRO HDMI X2');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('7','proyector-2','2',true,'Proyector EPSON ya instalado para aulas grandes. Métodos:
  HDMI X2
  MICRO HDMI X2');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('8','sala-general-1','1',true,'Sala general preparada para charlas locales.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('9','sala-general-2','1',true,'Sala general preparada para charlas con terceros externos.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('10','sala-general-3','1',true,'Sala general preparada para charlas locales de altos cargos.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('11','sala-general-4','1',true,'Sala general preparada para charlas con terceros externos de altos cargos.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('12','sala-general-5','1',true,'Sala general de emergencia preparada con varias funcionalidades para diferentes tipos de usos.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('13','sala-informatica-1','1',true,'Sala de trabajo que dispone de varios equipos de sobremesa. Total de equipos: 40.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('14','sala-informatica-2','1',true,'Sala de trabajo que dispone de varios equipos de sobremesa. Total de equipos: 20.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('15','taller-cocina','1',true,'Taller de cocina que tiene electrodómesticos de cocina, preparados para su uso.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('16','despacho para entrevistas 1','1',true,'Despacho preparado para entrevistas.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('17','despacho para entrevistas 2','1',true,'Despacho secundario preparado para entrevistas.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('18','salon de actos','1',true,'Salón con un total de 100 butacas preparado para charlas grandes y otras actividades de interacción.');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion) VALUES	('19','sala de reuniones','1',true,'Sala de reunión general con una mesa redonda y asientos, penada para reuniones rápidas de de 2 a 4 personas.');