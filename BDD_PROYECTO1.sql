...
INSERT INTO usuarios(usuario,nombre,apellido,password) VALUES	('jlara','joan','lara','123zxc');
INSERT INTO usuarios(usuario,nombre,apellido,password) VALUES	('javier','javier','cordobes','123qwe');
...
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('8','sala-general-1','1',true,'Sala general preparada para charlas locales.','sala_disciplinar_1');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('9','sala-general-2','1',true,'Sala general preparada para charlas con terceros externos.','sala_disciplinar_2');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('10','sala-general-3','1',true,'Sala general preparada para charlas locales de altos cargos.','sala_disciplinar_3');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('11','sala-general-4','1',true,'Sala general preparada para charlas con terceros externos de altos cargos.','sala_disciplinar_4');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('12','sala-general-5','1',true,'Sala general de emergencia preparada con varias funcionalidades para diferentes tipos de usos.','sala_disciplinaria_5');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('13','sala-informatica-1','1',true,'Sala de trabajo que dispone de varios equipos de sobremesa. Total de equipos: 40.','sala_informatica_1');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('14','sala-informatica-2','1',true,'Sala de trabajo que dispone de varios equipos de sobremesa. Total de equipos: 20.','sala_informatica_2');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('15','taller-cocina','1',true,'Taller de cocina que tiene electrodómesticos de cocina, preparados para su uso.','taller_cocina');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('16','despacho para entrevistas 1','1',true,'Despacho preparado para entrevistas.','sala_entrevistas_1');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('17','despacho para entrevistas 2','1',true,'Despacho secundario preparado para entrevistas.','sala_entrevista');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('18','salon de actos','1',true,'Salón con un total de 100 butacas preparado para charlas grandes y otras actividades de interacción.','salon_de_actos');
INSERT INTO recursos(id_recurso,recurso,tipo,disponible,descripcion,imagen) VALUES	('19','sala de reuniones','1',true,'Sala de reunión general con una mesa redonda y asientos, penada para reuniones rápidas de de 2 a 4 personas.','sala_reuniones');
